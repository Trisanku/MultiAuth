...
<body>
  <div class="container">
    ...
    <div class="cover">
      <!-- <div class="front"> -->
        <img src="desktop-wallpaper-best-pop-wide-hq-definition-background-collection-90s-pop-art.jpg" alt="">
      <!-- </div> -->
      <!-- <div class="back">
        ...
        <div class="form-content">
          ...
          <form action="{{route('account.authenticate'); }}" method="post">
            ...
            <div class="input-boxes">
              ...
              <div class="text sign-up-text">Don't have an account? <label for="flip"><a href="register.html"></a>Register now</label></div>
            </div>
        </form>
      </div>
